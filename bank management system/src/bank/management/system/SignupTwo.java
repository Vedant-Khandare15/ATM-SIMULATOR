...
public class SignupTwo extends JFrame implements ActionListener
{
    ...
    SignupTwo(String formno)
    {
        ...
        String valReligion[] = {"Hindu", "Muslim", "Sikh", "Christian", "Buddhist" ,"Othres"};
        ...
        String occupationValues[] = {"Salaried", "Self Occupied", "Business", "Student", "Retired", "others"};
        ...
        JLabel country = new JLabel("Senior Citizen : ");
        ...
        next.addActionListener(this);  // try it for practice
        add(next);
