...
public class SignupThree extends JFrame implements ActionListener 
{
    ...
    String formno;
        ...
        SignupThree(String formno)
        {
            ...
            r2 = new JRadioButton("Current Deposite");
            r2.setFont(new Font("Raleway", Font.BOLD, 16));
            r2.setBackground(Color.white);
            r2.setBounds(100,220,250,20);
            add(r2);
            
            r3 = new JRadioButton("Recurring Deposite Account");
            ...
            c7 = new JCheckBox("I Hereby Declairs that the above entered details are correct to the best of my knowledge ");
